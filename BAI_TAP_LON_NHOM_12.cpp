...
void printnhap(doanhthu dt) {
	cout << "*******************************************************************************\n";
	cout << setw(3) << left << "*";
	cout << setw(12) << left<< "Ngay";
	cout << setw(12) << left << "Tien mat";
	cout << setw(12) << left << "Visa";
	cout << setw(12) << left << "Momo";
	cout << setw(12) << left << "Platfrom";
	cout << setw(12) << left << "Tong doanh thu *" <<endl;
	cout << setw(3) << left <<"*";
	cout << setw(12) << left << dt.ngayban;
	cout << setw(12) << left<< dt.tienmat;
